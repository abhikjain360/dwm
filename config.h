...
static const char *fonts[]          = { "Ubuntu Mono Nerd Font:size=16", "Ubuntu Mono Nerd Font:pixelsize=16:antialias=true:autohint=true"  };
static char dmenufont[]             = "Ubuntu Mono Nerd Font:size=16";
static char normbgcolor[]           = "#222222";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#ff5577";
...
static Key keys[] = {
	...
	{ MODKEY,			XK_grave,	spawn,	SHCMD("bash ~/.local/bin/dmenuunicode") },
	...
	{ MODKEY|ShiftMask,		XK_q,		spawn,		SHCMD("sh ~/.local/bin/sysact") },
	{ MODKEY|ShiftMask,    		XK_l,		spawn,		SHCMD("sh ~/.local/bin/locker") },
	{ MODKEY,			XK_c,		spawn,		SHCMD("/usr/bin/google-chrome-stable") },
	{ MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD("sh ~/.local/bin/bookmarks2") },
	{ MODKEY,			XK_w,		spawn,		SHCMD("sh ~/.local/bin/bookmarks") },
	...
	{ MODKEY,			XK_F10,		xrdb,		{.v = NULL } },
	{ MODKEY,			XK_F11,		spawn,		SHCMD("xbacklight -5") },
	{ MODKEY,			XK_F12,		spawn,		SHCMD("xbacklight +5") },
