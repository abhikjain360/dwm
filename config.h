...
static const char *fonts[]          = { "TerminessTTFNerdFontMono:size=16", "TerminessTTFNerdFontMono:pixelsize=16:antialias=true:autohint=true"  };
static char dmenufont[]             = "TerminessTTFNerdFontMono:size=16";
...
static Key keys[] = {
	...
	{ Mod1Mask,     		XK_l,		spawn,		SHCMD("sh ~/.local/bin/locker") },
